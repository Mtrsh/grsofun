...
settings <- list(
  ...
  source_climate = "ERA5",
  dir_climate = "/Net/Groups/BGI/scratch/mterristi/PhD/Pmodel/grsofun/data/ERA5",
  dir_climate_tidy = "/Net/Groups/BGI/scratch/mterristi/PhD/Pmodel/grsofun/data/ERA5/tidy",
  source_fapar = "modis",
  file_fapar = "/Net/Groups/BGI/scratch/mterristi/PhD/Pmodel/grsofun/data/fapar/MODIS-C006_MOD15A2_LAI_FPAR_zmaw/MODIS-C006_MOD15A2__LAI_FPAR__LPDAAC__GLOBAL_0.5degree__UHAM-ICDC__2000_2018__MON__fv0.02.nc",
  dir_fapar_tidy = "/Net/Groups/BGI/scratch/mterristi/PhD/Pmodel/grsofun/data/fapar/MODIS-C006_MOD15A2_LAI_FPAR_zmaw/tidy/",
  file_whc = "/Net/Groups/BGI/scratch/mterristi/PhD/Pmodel/grsofun/data/mtc_data/cwdx80_forcing_halfdeg.nc",
  dir_whc_tidy = "/Net/Groups/BGI/scratch/mterristi/PhD/Pmodel/grsofun/data/mtc_data/tidy/",
